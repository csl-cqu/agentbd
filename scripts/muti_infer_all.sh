...
for Attack in "${attacks[@]}"; do
    ...
    test_data_path=xxx/NLPLab/AgentsBD/poison_data/${dataset}/1/$Attack
    output_csv_path=xxx/NLPLab/AgentsBD/bddata/muti_agent_infer_${dataset}/$Attack
    log_path=xxx/NLPLab/AgentsBD/logs/${dataset}_muti_agent_$Attack
