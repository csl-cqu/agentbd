...
test_dir=xxx/NLPLab/AgentsBD/poison_data/hsol/1

if [ $llm == "qwen" ]; then
    output_dir=xxx/NLPLab/AgentsBD/bddata/qwen_7b_infer_de_${num}_hsol
elif [ $llm == "llama" ]; then
    output_dir=xxx/NLPLab/AgentsBD/bddata/llama3_8b_infer_de_${num}_hsol
fi
